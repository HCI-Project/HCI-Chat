...
public class Upload implements Runnable{
    ...
    public void run() {
        try {       
            ...
            ui.chatText.append("[Applcation > Me] : File upload complete\n");
            ui.filePathButton.setEnabled(true); ui.sendFileButton.setEnabled(true);
            ui.filePathText.setVisible(true);
